...
function createReactNoop(reconciler, useMutation) {
  ...
  function cloneInstance(instance, type, oldProps, newProps, internalInstanceHandle, keepChildren, recyclableInstance) {
    {
  ...
  var hostConfig = useMutation ? assign({}, sharedHostConfig, {
    ...
    cloneHiddenInstance: function (instance, type, props, internalInstanceHandle) {
      var clone = cloneInstance(instance, type, props, props, internalInstanceHandle, true);
      clone.hidden = true;
      return clone;
    },
