    ...
    while (_node !== null) {
      ...
      if (_node.tag === HostComponent) {
        ...
        if (needsVisibilityToggle && isHidden) {
          ...
          var type = _node.type;
          instance = cloneHiddenInstance(instance, type, props, _node);
        }
        ...
        if (needsVisibilityToggle && isHidden) {
          ...
          _instance = cloneHiddenTextInstance(_instance, text, _node);
        }
...
function updateHostComponent(current, workInProgress, type, newProps, renderLanes) {
  if (supportsMutation) {
    ...
    var currentHostContext = getHostContext();
    var newInstance = cloneInstance(currentInstance, type, _oldProps, newProps, workInProgress, childrenUnchanged, recyclableInstance);
